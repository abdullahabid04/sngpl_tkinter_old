...
def Generate_Table(myFrame, width, title, x, y, fields=None, update_btn=None, total_labels=None):
    ...
    if fields != None:
        table.bind("<Control-e>",
                   lambda event, table=table, entries=fields, update=update_btn: Set_Edit_Mode(event, table, entries,
                                                                                               update))
